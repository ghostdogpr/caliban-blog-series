...
object TrainClient {
  ...
  object FacilityState {
    ...
    implicit val encoder: ArgEncoder[FacilityState] = new ArgEncoder[FacilityState] {
      override def encode(value: FacilityState): Value = value match {
        case FacilityState.ACTIVE   => StringValue("ACTIVE")
        case FacilityState.INACTIVE => StringValue("INACTIVE")
        case FacilityState.UNKNOWN  => StringValue("UNKNOWN")
      }
  ...
  object FacilityType {
    ...
    implicit val encoder: ArgEncoder[FacilityType] = new ArgEncoder[FacilityType] {
      override def encode(value: FacilityType): Value = value match {
        case FacilityType.ESCALATOR => StringValue("ESCALATOR")
        case FacilityType.ELEVATOR  => StringValue("ELEVATOR")
      }
  ...
  type Nearby
  object Nearby {
    def stations[A](count: Option[Int], offset: Option[Int])(
    ...
    def parkingSpaces[A](count: Option[Int], offset: Option[Int])(
    ...
    def travelCenters[A](count: Option[Int], offset: Option[Int])(
    ...
    def flinksterCars[A](count: Option[Int], offset: Option[Int])(
    ...
    def bikes[A](count: Option[Int], offset: Option[Int])(
  ...
  object Query {
    ...
    def nearby[A](latitude: Double, longitude: Double, radius: Option[Int])(
